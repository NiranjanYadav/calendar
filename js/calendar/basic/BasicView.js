...
function BasicView(element, calendar, viewName) {
	...
	function renderBasic(r, c, showNumbers, maxColumns) {
		...
		{ 
			...
			for (i=0; i<rowCnt; i++) {
				...
				s += "</tr>";
				var roomName = t.calendar.rooms[i].name;
				var roomID = t.calendar.rooms[i].room_id;
				var roomType = t.calendar.rooms[i].room_type;
				s0 += "<tr><td class='fc-wed fc-state-default fc-not-today'><div class='fc-day-content'><div style='position:relative' class='room-name' id='"+roomID+"'>"+roomName+" "+roomType+"<div class='edit-icon'></div></div></div></td></tr>";
			...
			tbody.find('tr').each(function() {
				...
				tr.find('td').each(function() {
					...
					// remove all class. This is required to highlight the re-used view's weekend's
					// modified for Roomsy. Jaeyun 2012-10-02
					td.removeClass('fc-mon');
					td.removeClass('fc-tue');
					td.removeClass('fc-wed');
					td.removeClass('fc-mon');
					td.removeClass('fc-thu');
					td.removeClass('fc-fri');
					td.removeClass('fc-sat');
					td.removeClass('fc-sun');
					td.addClass("fc-" +dayIDs[d.getDay()]);
